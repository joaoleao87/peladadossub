...
export interface ControlledMatchEvent {
  match?: { sequence_number: number; team_home: number; team_away: number };
  id: string;
...
export interface RecordingCut { id:string; session_id:string; event_id:string; clip_start_ms:number; clip_end_ms:number; status:"PENDING"|"PROCESSING"|"COMPLETED"|"ERROR"|"CANCELLED"; output_path:string|null; r2_key:string|null; mime_type:string|null; byte_size:number|null; error_message:string|null; }
