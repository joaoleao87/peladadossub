...
export interface Payment { id: string; user_id: string; pelada_id: string | null; tipo: 'mensalidade' | 'avulso'; valor: number; status: PaymentStatus; data_pagamento: string | null; data_vencimento?:string|null; competencia?:string|null; metodo_pagamento: 'pix' | 'dinheiro' | 'outro' | null; referencia: string | null; comprovante_path?:string|null; comprovante_enviado_em?:string|null; created_at: string; profile?: Profile }
