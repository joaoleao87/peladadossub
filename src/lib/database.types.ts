...
export interface PeladaSeries { id:string; nome:string; dia_semana:number; horario:string; local:string; limite_jogadores:number; antecedencia_mensalistas_horas:number; antecedencia_geral_horas:number; ativa:boolean }
