-- A pelada acontece às sextas; a abertura automática ocorre na quinta à noite.
update public.pelada_series
set dia_semana=5,horario='20:30',nome='Pelada de sexta',updated_at=now()
where ativa;
